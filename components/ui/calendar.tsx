    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "pointer-events-auto size-(--cell-size) cursor-pointer p-0 select-none aria-disabled:pointer-events-none aria-disabled:opacity-40",
  ...
  return (
    <Select value={value?.toString()} onValueChange={handleChange}>
      <SelectTrigger
        ...
        className="h-8 w-fit gap-1 rounded-md border-none bg-transparent px-2 text-sm font-semibold shadow-none hover:bg-accent"
      >
        <SelectValue>{selected?.label}</SelectValue>
      </SelectTrigger>
      <SelectContent align="center" className="max-h-64 min-w-24">
        {options?.map((option) => (
